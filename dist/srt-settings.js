 ...
 */
export function buildDefaultSrtSettings(runtime) {
 ...
 */
export function ensureCodexHome(_claudeFallbackBin, codexBin) {
    if (!codexBin) {
        // 没装 codex，不需要 CODEX_HOME，删旧 status（runtime=claude 时不要因为旧 status 拦截）
        if (fs.existsSync(CODEX_HOME_STATUS_FILE))
            fs.unlinkSync(CODEX_HOME_STATUS_FILE);
        return;
    }
...
//# sourceMappingURL=srt-settings.js.map