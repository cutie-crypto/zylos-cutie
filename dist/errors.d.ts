...
export declare const ErrorType: {
    ...
    readonly SANDBOX_UNAVAILABLE: "SANDBOX_UNAVAILABLE";
    /** claude / codex CLI 不在 PATH 或未登录或对应 bin 路径不存在 */
    readonly RUNNER_UNAVAILABLE: "RUNNER_UNAVAILABLE";
    /** runner 在 timeout_ms 内没返回 */
    readonly RUNNER_TIMEOUT: "RUNNER_TIMEOUT";
    /** runner 跑起来了但 exit != 0 / spawn error / stdout 解析失败 */
    readonly RUNNER_FAILURE: "RUNNER_FAILURE";
